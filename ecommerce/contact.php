            ...
            <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="address">
                    ...
                    <div class="address__details">
                        ...
                        <p>nhanhb2007200@student.ctu.edu.vn</p>
                    </div>
                </div>
                <div class="address">
                    <div class="address__icon">
            ...
            <div class="contact-form-wrap mt--60">
                <div class="col-xs-12">
                    <div class="contact-title">
                        <h2 class="title__line--6">Phản Hồi</h2>
                    </div>
                </div>
                <div class="col-xs-12">
                    <form id="contact-form" action="#" method="post">
                        <div class="single-contact-form">
                            <div class="contact-box name">
                                ...
                                <input type="email" id="mobile" name="mobile" placeholder="Số điện thoại*">
                            </div>
                        </div>
                        <div class="single-contact-form">
                        ...
                        <div class="contact-btn">
                            <button type="button" onclick="send_message()" class="fv-btn">Gửi</button>
                        </div>
                    </form>
