                            ...
                            <tbody>
                                <?php while($row=mysqli_fetch_assoc($res)) { ?>
                                    <tr>
                                        ...
                                        <td class="product-remove"><a href="javascript:void(0)" onclick="manage_cart('<?php echo $row['pid']?>','add')">Thêm vào giỏ hàng</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="buttons-cart--inner">
                                ...
                                <div class="buttons-cart checkout--btn">
                                    <a href="<?php echo SITE_PATH?>checkout.php">Đặt Hàng</a>
                                </div>
                            </div>
                        </div>
                    </div>
