				...
				<div class="col-xs-12">
					<div class="bradcaump__inner">
						<nav class="bradcaump-inner">
							...
							<span class="breadcrumb-item active">Đăng Nhập/Đăng Ký</span>
						</nav>
					</div>
				</div>
			</div>
...
<!-- Contact Area -->
<section class="htc__contact__area ptb--40 bg__white" style="margin-top:-60px;">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<div class="contact-form-wrap mt--60">
					<div class="col-xs-12">
						<div class="contact-title">
							<h2 class="title__line--6">Đăng Nhập</h2>
						</div>
					</div>
					<div class="col-xs-12">
			...
			<div class="col-md-6">
				<div class="contact-form-wrap mt--60">
					<div class="col-xs-12">
						<div class="contact-title">
							<h2 class="title__line--6">Đăng Ký</h2>
						</div>
					</div>
					<div class="col-xs-12">
						<form id="register-form" method="post">
							<div class="single-contact-form">
								<div class="contact-box name">
									<input type="text" name="name" id="name" placeholder="Tên của bạn*" style="width:100%">
								</div>
								<span class="field_error" id="name_error"></span>
							</div>
							<div class="single-contact-form">
								<div class="contact-box name" style="margin-right: 0;">
									<input type="text" name="email" id="email" placeholder="Email*" style="width:100%;">
									<button type="button" class="fv-btn email_sent_otp height_60px" onclick="email_sent_otp()">Gửi OTP</button>
									<input type="text" id="email_otp" placeholder="OTP" style="width:40%" class="email_verify_otp">
									<button type="button" class="fv-btn email_verify_otp height_60px" onclick="email_verify_otp()">Kiểm tra OTP</button>
							...
							<div class="contact-btn">
								<button type="button" class="fv-btn" onclick="user_register()" id="btn_register">Đăng Ký</button>
							</div>
						</form>
			...
			jQuery.ajax({
				...
				success:function(result){
					if(result=='done'){
						...
						jQuery('.email_sent_otp').html('Send OTP');
						jQuery('.email_sent_otp').attr('disabled',false);
						jQuery('#email_error').html('Email is wrong');
					}
				}
			});
		}
