		...
		<div class="row">
				...
				<div class="contact-form-wrap mt--60">
					<div class="col-xs-12">
						<div class="contact-title">
							<h2 class="title__line--6">Hồ sơ</h2>
						</div>
					</div>
					<div class="col-xs-12">
						<form id="login-form" method="post">
							<div class="single-contact-form">
								<label class="password_label">Tên của bạn</label>
							...
							<div class="contact-btn">
								<button type="button" class="fv-btn" onclick="update_profile()" id="btn_submit">Chỉnh sửa</button>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="contact-form-wrap mt--60">
					<div class="col-xs-12">
						<div class="contact-title">
							<h2 class="title__line--6">Thay đổi mật khẩu</h2>
						</div>
					</div>
					<div class="col-xs-12">
						<form method="post" id="frmPassword">
							<div class="single-contact-form">
								<label class="password_label">Mật khẩu hiện tại</label>
								<div class="contact-box name">
							...
							<div class="single-contact-form">
								<label class="password_label">Mật khẩu mới</label>
								<div class="contact-box name">
							...
							<div class="single-contact-form">
								<label class="password_label">Nhập lại mật khẩu mới</label>
								<div class="contact-box name">
							...
							<div class="contact-btn">
								<button type="button" class="fv-btn" onclick="update_password()" id="btn_update_password">Câp nhật</button>
