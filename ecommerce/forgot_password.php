...
<!-- Contact Area -->
<section class="htc__contact__area ptb--60 bg__white" style="margin-top: -90px;">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<div class="contact-form-wrap mt--60">
					<div class="col-xs-12">
						<div class="contact-title">
							<h2 class="title__line--6">Quên Mật Khẩu</h2>
						</div>
					</div>
					<div class="col-xs-12">
						<form id="login-form" method="post">
							...
							<div class="contact-btn">
								<button type="button" class="fv-btn" onclick="forgot_password()" id="btn_submit">Gửi</button>
							</div>
						</form>
