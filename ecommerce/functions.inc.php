...
function get_product($con,$limit='',$cat_id='', $product_id='',$search_str='', $sort_order='', $attr_id=''){
	$sql="select product.*,product_attributes.price,product_attributes.qty from product,product_attributes where product.status=1 and product.id=product_attributes.product_id";
	if($cat_id!=''){
...
function sentInvoice($con,$order_id){
			  ...
			  <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
				<tr>
				  <td class="email-masthead">
					<a href="http://localhost/php/ecommerce/index.php" class="f-fallback email-masthead_name">
					Graden.Home
				  </a>
				  </td>
				</tr>
					  ...
					  <tr>
						<td class="content-cell">
						  <div class="f-fallback">
									...
									<tr>
									  <td class="attributes_item">
										<span class="f-fallback">
											<strong>Amount Due:</strong> '.formatMoney($user_order['total_price']).' đ.
										</span>
									  </td>
									</tr>
								  ...
								  <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
									...
									while($row=mysqli_fetch_assoc($res)){
										...
										$html.='<tr>
										  ...
										  <td class="align-right" width="20%" class="purchase_item"><span class="f-fallback">'.formatMoney($pp).' đ</span></td>
										</tr>';
									}
									...
									$html.='<tr>
									  ...
									  <td width="20%" class="purchase_footer" valign="middle">
										<p class="f-fallback purchase_total">'.formatMoney($total_price).'đ</p>
									  </td>
									</tr>
								  </table>
								</td>
							...
							<p>If you have any questions about this invoice, simply reply to this email for help.</p>
							<p>Cheers,
							  <br>The Graden.Home</p>
							<!-- Sub copy -->
					...
					<table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
					  <tr>
						<td class="content-cell" align="center">
						  <p class="f-fallback sub align-center">&copy; 2023 Graden.Home - All rights reserved.</p>
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="nhanhb2007200@student.ctu.edu.vn";
	$mail->Password="pofgoqxjuumwyour";
	$mail->SetFrom("nhanhb2007200@student.ctu.edu.vn");
