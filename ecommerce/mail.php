                              ...
                              <td colspan="2">
                                <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                  ...
                                  while($row=mysqli_fetch_assoc($res)) {
                                    ...
                                    $html.='<tr>
                                      <td width="70%" class="purchase_item"><span class="f-fallback">'.$row['name'].'</span></td>
                                      <td class="align-right" width="30%" class="purchase_item"><span class="f-fallback">'.formatMoney($pp).'</span></td>
                                    </tr>';
                                  }
                                  ...
                                  $html.='<tr>
                                            ...
                                            <td width="30%" class="purchase_footer" valign="middle">
                                              <p class="f-fallback purchase_total">'.formatMoney($total_price).'</p>
                                            </td>
                                          </tr>
                                </table>
                              </td>
